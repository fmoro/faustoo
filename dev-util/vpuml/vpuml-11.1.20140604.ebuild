...
if [[ $(get_version_component_count) == 3 ]]; then
	...
	SRC_URI_FORMAT="http://%s.visual-paradigm.com/downloads/vp/${MY_PN}_Linux_64bit_NoInstall_${MY_PV}.tar.gz"
else
...
SRC_URI="http://www.visual-paradigm.com/downloads/vp/${MY_PN}_Linux_64bit_NoInstall_${MY_PV}.tar.gz"
