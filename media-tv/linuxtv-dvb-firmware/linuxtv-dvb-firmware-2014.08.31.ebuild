...
PACKET_NAME=dvb-firmwares.tar.bz2
...
# get_dvb_firmware
	...
	"mpc718"
	"usb-af9015"
#get_dvb_firmware previously not in use
	"av7110"
	"dec2000t"
	"dec2540t"
	"dec3000s"
	"nxt2004"
#get_dvb_firmware added @2014.08.31
	"vp7049"
	"nxt2002"
	"ngene"
	"az6027"
...
# own URL
	...
	"http://www.linuxtv.org/downloads/firmware/v4l-cx23885-enc-broken.fw"
...
# get_dvb_firmware
	"http://rsync16.de.gentoo.org/files/linuxtv-dvb-firmware/tt_Premium_217g.zip"
	"http://www.tt-download.com/download/updates/219/TT_PCI_2.19h_28_11_2006.zip"
	"http://theether.net/download/LifeView/LR306n/Drv_2.11.02.zip"
	...
	"http://rsync16.de.gentoo.org/files/linuxtv-dvb-firmware/AVerTVHD_MCE_A180_Drv_v1.2.2.16.zip"
