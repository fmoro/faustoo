...
HTTP_UPLOAD_PROGRESS_MODULE_PV="v0.9.0"
...
HTTP_HEADERS_MORE_MODULE_PV="v0.25"
...
HTTP_LUA_MODULE_URI="https://github.com/chaoslawful/lua-nginx-module/archive/${HTTP_LUA_MODULE_PV}.tar.gz"
...
HTTP_NAXSI_MODULE_PV="nx_util-0.3"
...
HTTP_RRD_GRAPH_MODULE_WD="${WORKDIR}/nginx_http_rrd_graph-${HTTP_RRD_GRAPH_MODULE_PV}"

# echo-nginx-module (https://github.com/agentzh/echo-nginx-module, BSD license)
HTTP_ECHO_MODULE_PV="0.48"
HTTP_ECHO_MODULE_P="ngx_http_echo-${HTTP_ECHO_MODULE_PV}"
HTTP_ECHO_MODULE_URI="https://github.com/agentzh/echo-nginx-module/archive/${HTTP_ECHO_MODULE_PV}.tar.gz"
