...
inherit autotools eutils pam python-any-r1 ruby-single user
...
IUSE="
	...
	postgres python readline redis ruby sqlite ssl
"
...
src_prepare() {
	...
	use redis || rm -r src/modules/rlm_redis{,who}
...
pkg_preinst() {
	...
	elog "If you are upgrading from freeradius 2.x, please, read: "
	elog "https://github.com/FreeRADIUS/freeradius-server/blob/v3.0.x/raddb/README.rst"
}
