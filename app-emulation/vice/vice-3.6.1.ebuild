...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="alsa cpuhistory debug doc ethernet ffmpeg flac gif +gtk headless ipv6 jpeg lame mpg123 ogg oss +opengl openmp parport pci png portaudio pulseaudio sdl sdlsound zlib"
...
src_configure() {
	...
	econf \
		...
		$(use_enable gtk native-gtk3ui) \
		$(use_enable doc pdf-docs) \
		$(use_enable portaudio) \
		--disable-sdlui \
		$(use_enable sdl sdlui2) \
