...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="Xaw3d alsa ethernet ffmpeg fullscreen +gtk headless ipv6 lame libav nls oss png pulseaudio sdl +sdlsound threads vte zlib"
...
src_prepare() {
	...
	sed -i \
		...
		src/arch/headless/archdep_unix.h \
		src/arch/shared/archdep_unix.h || die
