...
SRC_URI="
	x86? ( https://az764295.vo.msecnd.net/stable/${RELEASE}/code-stable-code_${PV}-1473369468_i386.tar.gz -> ${P}_i386.tar.gz )
	amd64? ( https://az764295.vo.msecnd.net/stable/${RELEASE}/code-stable-code_${PV}-1473370243_amd64.tar.gz -> ${P}_amd64.tar.gz )
	"
